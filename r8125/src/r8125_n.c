...
static ushort custom_led = 0;
module_param(custom_led, ushort, 0);
MODULE_PARM_DESC(custom_led, "Custom led reg");
...
rtl8125_init_software_variable(struct net_device *dev)
{
        ...
        if (custom_led > 0) {
                printk(KERN_INFO "%s: set custom_led to 0x%04x\n", MODULENAME, custom_led);
